              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                      ...
                      <motion.div
                          ...
                          variants={slideInRightVariants}
                      >
                          {/* Premium Phone-like Frame for Video Player */}
                          <a
                              href="https://www.instagram.com/reels/DFTHlJsSDxtCnnBeGXpF6L0k2J6RJPsLvIEYw80/"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="relative aspect-[9/16] w-full max-w-[320px] overflow-hidden rounded-[40px] border-[10px] border-stone-900 bg-black shadow-2xl ring-1 ring-stone-200 sm:max-w-[360px] group cursor-pointer"
                          >
                              <video
                                  src="https://assets.mixkit.co/videos/preview/mixkit-farmer-hands-holding-fresh-soil-with-organic-sprout-41551-large.mp4"
                                  autoPlay
                                  loop
                                  muted
                                  playsInline
                              ...
                              />
                              {/* Glowing play icon overlay on hover */}
                              <div className="absolute inset-0 bg-emerald-950/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 text-emerald-900 shadow-lg scale-90 group-hover:scale-100 transition-transform duration-300">
